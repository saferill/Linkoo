...
pub use linko::discovery::DeviceLogKind;
use linko::discovery::{
...
use linko::model::discovery::{DeviceType, ProtocolType};
use linko::multicast::{DEFAULT_MULTICAST_GROUP_V6, MulticastDevice};
...
///
/// Announcements are received from the IPv4 [group] and, as a Linko
...
pub async fn start_discovery(
    ...
    let handle = linko::discovery::start(
        DiscoveryConfig {
            group,
