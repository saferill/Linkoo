...
///   generated in Dart.
/// - `CN=Linko User` and no SANs: peers identify each other purely by the
...
pub fn generate_self_signed() -> anyhow::Result<SelfSignedCert> {
    ...
    params
        .distinguished_name
        .push(rcgen::DnType::CommonName, "Linko Secure Peer");
    params
        .distinguished_name
        .push(rcgen::DnType::OrganizationName, "Linko Mesh Network");
...
/// Encoded as uppercase hex, the format used for Linko fingerprints.
