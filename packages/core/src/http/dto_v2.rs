...
///
/// Sent to POST /api/linko/v2/register for device discovery.
...
///
/// Response from POST /api/linko/v2/register.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// Sent to POST /api/linko/v2/prepare-upload to initiate a file transfer.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// Response from POST /api/linko/v2/prepare-upload.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
///
/// Response from POST /api/linko/v2/prepare-download.
...
///
/// Response from GET /api/linko/v2/info.
