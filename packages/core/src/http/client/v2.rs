...
/// HTTP client for Linko Protocol v2.2.
...
impl LsHttpClientV2 {
    ...
    ///
    /// POST /api/linko/v2/prepare-upload
    ///
    ...
    ///
    /// POST /api/linko/v2/upload?sessionId=...&fileId=...&token=...
    ///
    ...
    ///
    /// POST /api/linko/v2/cancel?sessionId=...
    ///
    /// # Arguments
    /// * `protocol` - HTTP or HTTPS
    /// * `ip` - Receiver's IP address
    ...
    ///
    /// POST /api/linko/v2/prepare-download
    ///
    ...
    ///
    /// GET /api/linko/v2/download?sessionId=...&fileId=...
    ///
    /// This method can be called in parallel for multiple files.
    ///
    /// # Arguments
