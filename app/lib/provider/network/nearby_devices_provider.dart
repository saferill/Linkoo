...
import 'package:linko_app/model/state/nearby_devices_state.dart';
...
/// - Scanning the network for other Linko instances
...
/// It just sends an announcement which will cause a response on every other Linko member of the network.
