...
import 'package:linko_app/provider/network/webrtc/webrtc_receiver.dart';
...
import 'package:linko_isolates/rust/api/crypto.dart' as crypto;
import 'package:linko_isolates/rust/api/model.dart' as rust;
import 'package:linko_isolates/rust/api/webrtc.dart';
import 'package:refena_flutter/refena_flutter.dart';

part 'signaling_provider.mapper.dart';

/// WebRTC signaling enabled for cross-network and cloud transfer.
...
class SignalingService extends ReduxNotifier<SignalingState> {
  ...
  SignalingState init() {
    return SignalingState(
      signalingServers: _persistence.getSignalingServers() ?? ['wss://linko.saferill.workers.dev/v1/ws'],
      stunServers: _persistence.getStunServers() ?? ['stun:stun.l.google.com:19302'],
      connections: {},
    );
  }
}
