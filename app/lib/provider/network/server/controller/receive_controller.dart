...
import 'package:linko_app/model/state/server/receiving_file.dart';
import 'package:linko_app/pages/home_page.dart';
import 'package:linko_app/pages/home_page_controller.dart';
import 'package:linko_app/pages/progress_page.dart';
import 'package:linko_app/pages/receive_page.dart';
...
import 'package:linko_app/provider/http_provider.dart';
...
import 'package:linko_app/provider/network/server/server_utils.dart';
import 'package:linko_app/provider/receive_history_provider.dart';
import 'package:linko_app/provider/security_provider.dart';
import 'package:linko_app/provider/selection/selected_receiving_files_provider.dart';
...
import 'package:linko_app/widget/dialogs/open_file_dialog.dart';
...
import 'package:linko_isolates/rust/api/server.dart' show SessionEndReasonV2;
import 'package:linko_isolates/util/rust.dart';
...
class ReceiveController {
  ...
  void onShow(HttpServerShowEvent event) {
    ...
    server.ref.redux(selectedSendingFilesProvider).dispatchAsyncTakeResult(LoadSelectionFromArgsAction(args)).then((filesAdded) {
      if (filesAdded) {
        server.ref.redux(homePageControllerProvider).dispatch(ChangeTabAction(HomeTab.devices));
      }
    });
  }
