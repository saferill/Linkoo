...
import 'package:linko_app/model/persistence/quick_save_mode.dart';
import 'package:linko_app/model/persistence/receive_history_entry.dart';
import 'package:linko_app/model/send_mode.dart';
...
import 'package:linko_app/util/security_helper.dart';
import 'package:linko_app/util/shared_preferences/shared_preferences_file.dart';
import 'package:linko_app/util/shared_preferences/shared_preferences_portable.dart';
import 'package:linko_app/util/ui/animations_status.dart';
import 'package:linko_isolates/constants.dart';
import 'package:linko_isolates/model/device.dart';
import 'package:linko_isolates/model/stored_security_context.dart';
...
String get _windowsFile {
  ...
  return '$appData\\Linko\\settings.json';
}

String get _windowsLegacyFile {
  final appData = Platform.environment['APPDATA'];
  return '$appData\\org.linko\\linko_app\\shared_preferences.json';
}
...
class PersistenceService {
  ...
  ColorMode getColorMode() {
    ...
    if (value == null) {
      return ColorMode.linko;
    }
    return ColorMode.values.firstWhereOrNull((color) => color.name == value) ?? ColorMode.linko;
  }
