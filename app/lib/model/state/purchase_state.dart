...
enum PurchaseItem {
  donate5(
    androidId: 'linko_android_donate_5',
    iosId: 'linko_ios_donate_5',
  ),
  donate10(
    androidId: 'linko_android_donate_10',
    iosId: 'linko_ios_donate_10',
  ),
  donate20(
    androidId: 'linko_android_donate_20',
    iosId: 'linko_ios_donate_20',
  ),
  donate50(
    androidId: 'linko_android_donate_50',
    iosId: 'linko_ios_donate_50',
  )
  ;
