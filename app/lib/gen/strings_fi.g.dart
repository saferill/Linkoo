...
class _Translations$networkInterfacesPage$fi extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Oletuksena Linko käyttää kaikkia saatavilla olevia verkkoliitäntöjä. Voit sulkea pois verkkoliitännät, joita et halua. Sinun tulee uudelleenkäynnistää Linko ottaaksesi muutokset käyttöön.';
  @override
...
class _Translations$receiveOptionsPage$fi extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Linko-kansio)';
  @override
...
class _Translations$webSharePage$fi extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko käyttää itse allekirjoitettua sertifikaattia. Sinun on hyväksyttävä se selaimessasi.';
  @override
...
class _Translations$aboutPage$fi extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Tietoja Linkoista';
  @override
  List<String> get description => [
    'Linko on ilmainen, avoimen lähdekoodin sovellus, jonka avulla voit turvallisesti jakaa tiedostoja ja lähettää viestejä läheisten laitteiden kanssa paikallisessa verkossasi ilman internet-yhteyttä.',
    'Linko on saatavilla Androidille, iOS:lle, Linuxille, macOS:lle ja Windowsille. Kaikki latausvaihtoehdot löytyvät virallisilta kotisivuilta.',
  ];
  @override
...
class _Translations$donationPage$fi extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Linko on ilmainen, avoimen lähdekoodin sovellus ilman mainoksia. Voit tukea projektia lahjoituksella, jos pidät sovelluksesta.';
  @override
...
class _Translations$settingsTab$general$fi extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näytä Linko kontekstivalikossa';
  @override
...
class _Translations$settingsTab$network$fi extends Translations$settingsTab$network$en {
  ...
  @override
  String get needRestart => 'Käynnistä Linko uudelleen saadaksesi muutokset käyttöön!';
  @override
...
class _Translations$settingsTab$other$fi extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Tue Linkoia';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$fi extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Linko ei löydä muita laitteita ilman lupaa skannata paikallisverkkoa. Anna tämä lupa asetuksissa.';
  @override
...
class _Translations$dialogs$sendModeHelp$fi extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Vastaanottajat, joilla ei ole Linkoia asennettuna, voivat ladata valitut tiedostot avaamalla linkin selaimessaan.';
}
