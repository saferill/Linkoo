...
class _Translations$networkInterfacesPage$sl extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Linko privzeto uporablja vse razpoložljive omrežne vmesnike. Tukaj lahko izključite neželena omrežja. Za uveljavitev sprememb morate znova zagnati strežnik.';
  @override
...
class _Translations$receiveOptionsPage$sl extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(mapa Linko)';
  @override
...
class _Translations$webSharePage$sl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko uporablja samopodpisano potrdilo. Sprejeti ga morate v svojem brskalniku.';
  @override
...
class _Translations$aboutPage$sl extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    'Linko je brezplačna, odprtokodna aplikacija, ki vam omogoča varno deljenje datotek in sporočil z napravami v bližini prek lokalnega omrežja brez potrebe po internetni povezavi.',
...
class _Translations$donationPage$sl extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Linko je brezplačna, odprtokodna in brez oglasov. Če vam je aplikacija všeč, lahko podprete razvoj z donacijo.';
  @override
...
class _Translations$settingsTab$general$sl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Prikaži Linko v kontekstnem meniju';
  @override
...
class _Translations$settingsTab$other$sl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podprite Linko';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$sl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Linko ne more najti drugih naprav brez dovoljenja za iskanje v lokalnem omrežju. Prosim, omogočite to dovoljenje v nastavitvah.';
  @override
...
class _Translations$dialogs$sendModeHelp$sl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Prejemniki, ki nimajo nameščenega Linko, lahko prenesejo izbrane datoteke z odpiranjem povezave v brskalniku.';
}
