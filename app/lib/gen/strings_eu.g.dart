...
class _Translations$networkInterfacesPage$eu extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Lehenespenez, Linko-ek eskuragarri dauden sare-interfaze guztiak erabiltzen ditu. Nahi ez dituzun sareak hemen baztertu ditzakezu. Zerbitzaria berrabiarazi behar duzu aldaketak aplikatzeko.';
  @override
...
class _Translations$webSharePage$eu extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko-ek autosinatutako zertifikatuak erabiltzen ditu. Nabigatzailean onartu behar duzu';
  @override
...
class _Translations$aboutPage$eu extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Linko buruz';
  @override
  List<String> get description => [
    'Linko doako eta kode irekiko aplikazio bat da, gertuko gailuekin fitxategiak eta mezuak modu seguruan partekatzeko aukera ematen dizuna zure sare lokalaren bidez, interneteko konexiorik behar izan gabe.',
...
class _Translations$donationPage$eu extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Linko doakoa da, kode irekikoa eta iragarkirik gabea. Aplikazioa gustuko baduzu, garapena dohaintza batekin lagun dezakezu.';
  @override
...
class _Translations$settingsTab$general$eu extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Erakutsi Linko testuinguru menuan';
  @override
...
class _Translations$settingsTab$other$eu extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Linko Lagundu';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$eu extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Sare lokala eskaneatzeko baimenik gabe, Linko-ek ezin ditu inguruko gailuak aurkitu. Mesedez, onartu baimen hau ezarpenetan.';
  @override
...
class _Translations$dialogs$sendModeHelp$eu extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Linko instalatuta ez duten hartzaileak fitxategiak eskuratu ahali zango dituzte lotura nabigatzailean zabalduz.';
}
