...
class _Translations$networkInterfacesPage$cs extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Ve výchozím nastavení používá Linko všechna dostupná síťová rozhraní. Zde můžete vyloučit nežádoucí sítě. Chcete-li použít změny, musíte restartovat server.';
  @override
...
class _Translations$webSharePage$cs extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko používá self-signed certifikát. Musíte ho přijmout ve vašem prohlížeči.';
  @override
...
class _Translations$aboutPage$cs extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'O aplikaci Linko';
  @override
  List<String> get description => [
    'Linko je bezplatná aplikace s otevřeným zdrojovým kódem, která vám umožňuje bezpečně sdílet soubory a zprávy s okolními zařízeními přes vaši místní síť, aniž byste potřebovali připojení k internetu.',
...
class _Translations$donationPage$cs extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Linko je zdarma, open source a bez reklam. Pokud se vám aplikace líbí, můžete její vývoj podpořit darem.';
  @override
...
class _Translations$tray$cs extends Translations$tray$en {
  ...
  @override
  String get close => 'Ukončit Linko';
  @override
...
class _Translations$settingsTab$general$cs extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Zobrazit Linko v kontextové nabídce';
  @override
...
class _Translations$settingsTab$other$cs extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podpora Linko';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$cs extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Linko nemůže najít jiná zařízení, aniž by měl oprávnění skenovat místní síť. Udělte prosím toto oprávnění v nastavení.';
  @override
...
class _Translations$dialogs$sendModeHelp$cs extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Příjemci, kteří nemají nainstalovaný Linko, si mohou vybrané soubory stáhnout otevřením odkazu ve svém prohlížeči.';
}
