...
class _Translations$networkInterfacesPage$uz extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Standart holatda Linko barcha mavjud tarmoq interfeyslaridan foydalanadi. Bu yerda keraksiz tarmoqlarni chiqarib tashlashingiz mumkin. Oʻzgarishlarni qoʻllash uchun serverni qayta ishga tushirishingiz kerak.';
  @override
...
class _Translations$receiveOptionsPage$uz extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Linko papkasi)';
  @override
...
class _Translations$webSharePage$uz extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko oʻz-oʻzini imzolagan sertifikatdan foydalanadi. Uni brauzeringizda qabul qilishingiz kerak.';
  @override
...
class _Translations$aboutPage$uz extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Linko haqida';
  @override
  List<String> get description => [
    'Linko — bu bepul, ochiq manbali ilova boʻlib, u internet ulanishisiz mahalliy tarmoq orqali yaqin atrofdagi qurilmalar bilan fayllar va xabarlarni xavfsiz ulashish imkonini beradi.',
...
class _Translations$donationPage$uz extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Linko bepul, ochiq manbali va reklamasiz. Agar ilova sizga yoqqan boʻlsa, xayriya bilan rivojlanishni qoʻllab-quvvatlashingiz mumkin.';
  @override
...
class _Translations$tray$uz extends Translations$tray$en {
  ...
  @override
  String get close => 'Linkodan chiqish';
  @override
...
class _Translations$settingsTab$general$uz extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Linkoni kontekst menyusida koʻrsatish';
  @override
...
class _Translations$settingsTab$other$uz extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Linkoni qoʻllab-quvvatlash';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$uz extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Linko mahalliy tarmoqni skanerlash ruxsatisiz boshqa qurilmalarni topa olmaydi. Iltimos, ushbu ruxsatni sozlamalarda bering.';
  @override
...
class _Translations$dialogs$sendModeHelp$uz extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Linko oʻrnatilmagan qabul qiluvchilar havolani brauzerlarida ochish orqali tanlangan fayllarni yuklab olishlari mumkin.';
}
