...
class _Translations$networkInterfacesPage$be extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Прадвызначана, Linko выкарыстоўвае ўсе даступныя сеткавыя інтэрфейсы. Тут вы можаце выключыць непажаданыя сеткі. Каб змяненні ўступілі ў сілу, трэба перазапусціць сервер.';
  @override
...
class _Translations$webSharePage$be extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko выкарыстоўвае самападпісаны сертыфікат. Вам трэба прыняць яго ў браўзеры.';
  @override
...
class _Translations$aboutPage$be extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Пра Linko';
  @override
  List<String> get description => [
    'Linko — гэта бясплатная праграма з адкрытым зыходным кодам, якая дазваляе бяспечна абменьвацца файламі і паведамленнямі з прыладамі побач праз лакальную сетку без інтэрнэт-злучэння.',
...
class _Translations$donationPage$be extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Linko — бясплатная праграма з адкрытым зыходным кодам і без рэкламы. Калі вам падабаецца праграма, вы можаце падтрымаць яе распрацоўку ахвяраваннем.';
  @override
...
class _Translations$tray$be extends Translations$tray$en {
  ...
  @override
  String get close => 'Выйсці з Linko';
  @override
...
class _Translations$settingsTab$general$be extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Паказваць Linko у кантэкстным меню';
  @override
...
class _Translations$settingsTab$other$be extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Падтрымаць Linko';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$be extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Linko не можа знайсці іншыя прылады, не маючы дазволу на сканіраванне лакальнай сеткі. Дайце гэты дазвол у наладах.';
  @override
...
class _Translations$dialogs$sendModeHelp$be extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Атрымальнікі, у якіх не ўсталяваны Linko, могуць спампаваць выбраныя файлы, адкрыўшы спасылку ў браўзеры.';
}
