...
class _Translations$networkInterfacesPage$fr extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Par défaut, Linko utilise toutes les interfaces réseau disponibles. Vous pouvez exclure les réseaux indésirables ici. Vous aurez besoin de redémarrer le serveur pour appliquer les changements.';
  @override
...
class _Translations$receiveOptionsPage$fr extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(dossier Linko)';
  @override
...
class _Translations$webSharePage$fr extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
  @override
...
class _Translations$aboutPage$fr extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'À propos de Linko';
  @override
  List<String> get description => [
    'Linko est un logiciel gratuit et open-source qui vous permet de partager de manière sécurisée des fichiers et des messages avec d\'autres appareils connectés à votre réseau local. Une connexion à internet n\'est pas requise.',
    'Linko est disponible sur Android, iOS, macOS, Windows et Linux. Vous pouvez accéder à ces téléchargements depuis la page officielle.',
  ];
  @override
...
class _Translations$donationPage$fr extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Linko est gratuit, open-source et sans aucune pub. Si vous aimez ce logiciel, vous pouvez faire un don pour soutenir son développement.';
  @override
...
class _Translations$tray$fr extends Translations$tray$en {
  ...
  @override
  String get close => 'Quitter Linko';
  @override
...
class _Translations$settingsTab$general$fr extends Translations$settingsTab$general$en {
  ...
  @override
  String get launchAtStartup => 'Lancer Linko à la connexion de l\'utilisateur';
  @override
  String get launchMinimized => 'Minimiser Linko lors du lancement';
  @override
  String get showInContextMenu => 'Afficher Linko dans le menu contextuel';
  @override
...
class _Translations$settingsTab$other$fr extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Soutenir Linko';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$fr extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Linko ne peut pas trouver d\'autres appareils sans la permission de scanner votre réseau local. Veuillez donner cette permission à Linko dans les paramètres système.';
  @override
...
class _Translations$dialogs$noPermission$fr extends Translations$dialogs$noPermission$en {
  ...
  // Translations
  @override
  String get title => 'Linko n\'a pas la permission';
  @override
...
class _Translations$dialogs$sendModeHelp$fr extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Les destinataires n\'ayant pas Linko installé peuvent télécharger les fichiers sélectionnés en ouvrant le lien dans leur navigateur.';
}
