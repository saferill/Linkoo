...
class _Translations$networkInterfacesPage$hy extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Լռելյայն, Linko-ը օգտագործում է բոլոր հասանելի ցանցային ինտերֆեյսները: Այստեղ կարող եք բացառել անցանկալի ցանցերը: Փոփոխությունները կիրառելու համար պետք է թարմացնել սերվերը:';
  @override
...
class _Translations$receiveOptionsPage$hy extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Linko պանակ)';
  @override
...
class _Translations$webSharePage$hy extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko-ը օգտագործում է ինքնաստորագրված վկայական։ Դուք պետք է ընդունեք այն ձեր բրաուզերում։';
  @override
...
class _Translations$aboutPage$hy extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Linko-ի մասին';
  @override
  List<String> get description => [
    'Linko-ը անվճար, բաց կոդով ծրագիր է, որը թույլ է տալիս անվտանգ կերպով կիսվել ֆայլերով և նամակներով մոտակա սարքերի հետ ձեր տեղական ցանցի միջոցով՝ առանց ինտերնետ կապի անհրաժեշտության:',
...
class _Translations$donationPage$hy extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Linko-ը անվճար է, բաց կոդով և առանց որևէ գովազդի: Եթե ​​ձեզ դուր է գալիս ծրագիրը, կարող եք աջակցել զարգացմանը նվիրաբերելով:';
  @override
...
class _Translations$tray$hy extends Translations$tray$en {
  ...
  @override
  String get close => 'Դուրս գալ Linko-ից';
  @override
...
class _Translations$settingsTab$general$hy extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Ցուցադրել Linko-ը կոնտեքստային մենյուում';
  @override
...
class _Translations$settingsTab$other$hy extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Աջակցել Linko-ին';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$hy extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Linko-ը չի կարող գտնել այլ սարքեր՝ առանց այդ թույլտվության: Խնդրում ենք տրամադրել այս թույլտվությունը կարգավորումներում:';
  @override
...
class _Translations$dialogs$sendModeHelp$hy extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Ստացողները, որոնք չունեն Linko տեղադրված, կարող են ներբեռնել ընտրված ֆայլերը՝ բացելով հղումը իրենց բրաուզերում։';
}
