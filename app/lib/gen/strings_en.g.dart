...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, Linko uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, Linko uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(Linko folder)'
  String get appDirectory => '(Linko folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'Linko uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'Linko uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About Linko'
  String get title => 'About Linko';

  List<String> get description => [
    'Linko is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class Translations$donationPage$en {
  ...
  /// en: 'Linko is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'Linko is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show Linko in context menu'
  String get showInContextMenu => 'Show Linko in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support Linko'
  String get support => 'Support Linko';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'Linko can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'Linko can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have Linko installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have Linko installed can download the selected files by opening the link in their browser.';
}
