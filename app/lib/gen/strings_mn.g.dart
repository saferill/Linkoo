...
class _Translations$networkInterfacesPage$mn extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Анхдагчаар Linko боломжтой бүх сүлжээний интерфэйсийг ашигладаг. Та хүсээгүй сүлжээг эндээс хасаж болно. Өөрчлөлтийг хэрэгжүүлэхийн тулд серверийг дахин эхлүүлэх шаардлагатай.';
  @override
...
class _Translations$receiveOptionsPage$mn extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Linko-н хавтас)';
  @override
...
class _Translations$webSharePage$mn extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Linko нь өөрийн гарын үсэг ашигладаг тул үүнийг browser дээрээ хүлээн зөвшөөрнө үү.';
  @override
...
class _Translations$aboutPage$mn extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Linko танилцуулга';
  @override
  List<String> get description => [
    'Linko нь үнэгүй, нээлттэй эхийн програм бөгөөд танд интернет холболт шаардлагагүйгээр өөрийн дотоод сүлжээгээр ойролцоох төхөөрөмжүүдтэй файл, мессежийг аюулгүйгээр хуваалцах боломтой.',
...
class _Translations$donationPage$mn extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Linko нь үнэ төлбөргүй, нээлттэй эх сурвалжтай бөгөөд ямар ч зар сурталчилгаагүй. Хэрэв энэ програм таалагдсан бол хандивын мөнгөөр хөгжлийг дэмжих боломжтой.';
  @override
...
class _Translations$tray$mn extends Translations$tray$en {
  ...
  @override
  String get close => 'Linko-с гарах';
  @override
...
class _Translations$settingsTab$general$mn extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Системийн цэсэнд Linko-д харуулах';
  @override
...
class _Translations$settingsTab$other$mn extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Linko-г дэмжих';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$mn extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Дотоод сүлжээг скан хийх зөвшөөрөлгүйгээр Linko бусад төхөөрөмжийг олж чадахгүй. Энэ зөвшөөрлийг тохиргооноос олгоно уу.';
  @override
...
class _Translations$dialogs$sendModeHelp$mn extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Linko суулгаагүй хүлээн авагчид холбоосыг хөтчөөрөө нээж сонгосон файлуудыг татаж авах боломжтой.';
}
