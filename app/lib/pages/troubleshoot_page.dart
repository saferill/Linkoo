...
import 'package:linko_app/util/native/cmd_helper.dart';
import 'package:linko_app/util/native/macos_channel.dart' as macos_channel;
import 'package:linko_app/util/native/platform_check.dart';
import 'package:linko_app/widget/custom_icon_button.dart';
import 'package:linko_app/widget/dialogs/not_available_on_platform_dialog.dart';
            ...
            primaryButton: _FixButton(
              ...
              onTapMap: {
                TargetPlatform.windows: _CommandFixAction(
                  ...
                  commands: [
                    'netsh advfirewall firewall add rule name="Linko" dir=in action=allow protocol=TCP localport=${settings.port}',
                    'netsh advfirewall firewall add rule name="Linko" dir=in action=allow protocol=UDP localport=${settings.port}',
                  ],
                ),
              },
            ),
