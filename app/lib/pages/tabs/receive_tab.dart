...
import 'package:linko_app/pages/receive_history_page.dart';
...
import 'package:linko_app/widget/column_list_view.dart';
                        ...
                        InitialFadeTransition(
                          ...
                          child: Consumer(
                            builder: (context, ref) {
                              ...
                              return PulseWidget(
                                active: serverState != null && animations && activeTab == HomeTab.devices,
                                child: const LinkoLogo(withText: false),
                              );
                            },
                          ),
                        ),
