...
import 'package:linko_app/pages/settings/network_interfaces_page.dart';
import 'package:linko_app/pages/tabs/settings_tab_controller.dart';
...
import 'package:linko_app/util/alias_generator.dart';
import 'package:linko_app/util/device_type_ext.dart';
import 'package:linko_app/util/i18n.dart';
import 'package:linko_app/util/native/macos_channel.dart';
import 'package:linko_app/util/native/pick_directory_path.dart';
import 'package:linko_app/util/native/platform_check.dart';
import 'package:linko_app/widget/custom_dropdown_button.dart';
import 'package:linko_app/widget/dialogs/encryption_disabled_notice.dart';
import 'package:linko_app/widget/dialogs/pin_dialog.dart';
import 'package:linko_app/widget/dialogs/quick_save_from_favorites_notice.dart';
import 'package:linko_app/widget/dialogs/quick_save_notice.dart';
import 'package:linko_app/widget/dialogs/text_field_tv.dart';
import 'package:linko_app/widget/dialogs/text_field_with_actions.dart';
import 'package:linko_app/widget/labeled_checkbox.dart';
            ...
            _SettingsSection(
              ...
              children: [
                ...
                if (checkPlatformIsDesktop()) ...[
                  /// Wayland does window position handling, so there's no need for it. See [https://github.com/linko/linko/issues/544]
            ...
            _SettingsSection(
              ...
              children: [
                ...
                _ButtonEntry(
                  ...
                  onTap: () async {
                    await launchUrl(
                      Uri.parse('https://getlinko.pages.dev/privacy'),
