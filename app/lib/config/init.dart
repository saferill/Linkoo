...
import 'package:linko_app/config/refena.dart';
...
import 'package:linko_app/pages/whats_new_page.dart';
import 'package:linko_app/provider/animation_provider.dart';
import 'package:linko_app/provider/app_arguments_provider.dart';
...
import 'package:linko_app/provider/network/webrtc/signaling_provider.dart';
import 'package:linko_app/provider/persistence_provider.dart';
import 'package:linko_app/provider/purchase_provider.dart';
...
import 'package:linko_app/provider/tv_provider.dart';
import 'package:linko_app/provider/version_provider.dart';
import 'package:linko_app/provider/window_dimensions_provider.dart';
import 'package:linko_app/util/i18n.dart';
import 'package:linko_app/util/native/autostart_helper.dart';
import 'package:linko_app/util/native/cache_helper.dart';
import 'package:linko_app/util/native/channel/android_channel.dart';
import 'package:linko_app/util/native/context_menu_helper.dart';
import 'package:linko_app/util/native/cross_file_converters.dart';
import 'package:linko_app/util/native/device_info_helper.dart';
import 'package:linko_app/util/native/macos_channel.dart';
import 'package:linko_app/util/native/platform_check.dart';
import 'package:linko_app/util/native/tray_helper.dart';
...
import 'package:linko_app/widget/dialogs/local_network_dialog.dart';
import 'package:linko_isolates/isolate.dart';
import 'package:linko_isolates/model/dto/file_dto.dart';
import 'package:linko_isolates/model/dto/multicast_dto.dart';
import 'package:linko_isolates/rust/api/logging.dart' as rust_logging;
import 'package:linko_isolates/rust/frb_generated.dart';
import 'package:linko_isolates/util/logger.dart';
import 'package:linko_isolates/util/show_instance.dart';
import 'package:linko_isolates/util/transfer_notification.dart';
  ...
  if (appStart) {
    if (defaultTargetPlatform == TargetPlatform.macOS) {
      ...
      pendingStringsStream.listen((pendingStrings) {
        ...
        ref.redux(homePageControllerProvider).dispatch(ChangeTabAction(HomeTab.devices));
      });
